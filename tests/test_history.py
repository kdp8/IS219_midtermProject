...
class TestHistory(unittest.TestCase):
    ...
    def test_load_history(self, mock_read_csv):
        ...
        mock_read_csv.assert_called_with('history.csv')
    ...
    def test_delete_history(self, mock_to_csv, mock_read_csv):
        ...
        mock_to_csv.assert_called_with('history.csv', index=False)
    ...
    def test_add_history(self, mock_file_open):
        ...
        mock_file_open.assert_called_with('history.csv', 'a', newline='')
    ...
    def test_clear_history(self, mock_file_open):
        ...
        mock_file_open.assert_called_with('history.csv', 'w', newline='')
